...
describe('execute', () => {
	...
	it('should execute', async() => {
		...
		stdoutCalledWith(mockStdout, [
			...
			'[command]git fetch --no-tags --no-recurse-submodules get-diff-action \'refs/pull/55/merge:refs/pull/55/merge\' \'refs/heads/master:refs/remotes/get-diff-action/master\'',
