...
exports.getDiffInfoForPush = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    if (!(yield exports.isDefaultBranch(octokit, context))) {
        ...
        if (/^0+$/.test(context.payload.before)) {
            ...
            const pulls = (yield octokit.paginate(octokit.repos.listPullRequestsAssociatedWithCommit.endpoint.merge({
                owner: context.repo.owner,
                repo: context.repo.repo,
                'commit_sha': context.sha,
            })));
            return {
                base: github_action_helper_1.Utils.normalizeRef(pulls[0].base.ref),
