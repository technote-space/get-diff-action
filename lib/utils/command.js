...
exports.getFileDiff = (file, between) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
...
exports.getGitDiff = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const between = `"${github_action_helper_1.Utils.replaceAll(getFrom(), /[^\\]"/g, '\\"')}"${getDot()}"${github_action_helper_1.Utils.replaceAll(getTo(), /[^\\]"/g, '\\"')}"`;
    ...
    return (yield Promise.all(github_action_helper_1.Utils.split((yield command.execAsync({
        ...
        .map((item) => __awaiter(void 0, void 0, void 0, function* () { return (Object.assign(Object.assign({}, item), yield exports.getFileDiff(item, between))); }))))
