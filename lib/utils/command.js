...
exports.getGitDiff = (logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (github_action_helper_1.Utils.isRef(diffInfo.base) && github_action_helper_1.Utils.isRef(diffInfo.head)) {
        yield helper.fetchOrigin(github_action_helper_1.Utils.getWorkspace(), context, [
            ...
            github_action_helper_1.Utils.getRefspec(diffInfo.base, constant_1.REMOTE_NAME),
            github_action_helper_1.Utils.getRefspec(diffInfo.head, constant_1.REMOTE_NAME),
        ]);
    }
    else {
        yield helper.fetchOrigin(github_action_helper_1.Utils.getWorkspace(), context, [
            ...
            github_action_helper_1.Utils.getRefspec(context.ref, constant_1.REMOTE_NAME),
        ]);
    }
