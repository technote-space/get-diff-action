...
export declare type RestEndpointMethodTypes = {
    actions: {
        ...
        retryWorkflow: {
            parameters: RequestParameters & Omit<Endpoints["POST /repos/{owner}/{repo}/actions/runs/{run_id}/retry"]["parameters"], "baseUrl" | "headers" | "mediaType">;
    ...
    apps: {
        ...
        createContentAttachmentForRepo: {
            parameters: RequestParameters & Omit<Endpoints["POST /repos/{owner}/{repo}/content_references/{content_reference_id}/attachments"]["parameters"], "baseUrl" | "headers" | "mediaType">;
