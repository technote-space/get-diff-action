...
export declare type RestEndpointMethodTypes = {
    ...
    codeScanning: {
        getAlert: {
            parameters: RequestParameters & Omit<Endpoints["GET /repos/:owner/:repo/code-scanning/alerts/:alert_id"]["parameters"], "baseUrl" | "headers" | "mediaType">;
    ...
    migrations: {
        ...
        listReposForUser: {
            parameters: RequestParameters & Omit<Endpoints["GET /user/:migration_id/repositories"]["parameters"], "baseUrl" | "headers" | "mediaType">;
    ...
    repos: {
        ...
        deleteDownload: {
            parameters: RequestParameters & Omit<Endpoints["DELETE /repos/:owner/:repo/downloads/:download_id"]["parameters"], "baseUrl" | "headers" | "mediaType">;
        ...
        getArchiveLink: {
            parameters: RequestParameters & Omit<Endpoints["GET /repos/:owner/:repo/:archive_format/:ref"]["parameters"], "baseUrl" | "headers" | "mediaType">;
        ...
        getDownload: {
            parameters: RequestParameters & Omit<Endpoints["GET /repos/:owner/:repo/downloads/:download_id"]["parameters"], "baseUrl" | "headers" | "mediaType">;
        ...
        listDownloads: {
            parameters: RequestParameters & Omit<Endpoints["GET /repos/:owner/:repo/downloads"]["parameters"], "baseUrl" | "headers" | "mediaType">;
        ...
        uploadReleaseAsset: {
            parameters: RequestParameters & Omit<Endpoints["POST /repos/:owner/:repo/releases/:release_id/assets{?name,label}"]["parameters"], "baseUrl" | "headers" | "mediaType">;
