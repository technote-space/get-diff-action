...
export declare type RestEndpointMethods = {
    actions: {
         ...
         */
        retryWorkflow: {
            (params?: RestEndpointMethodTypes["actions"]["retryWorkflow"]["parameters"]): Promise<RestEndpointMethodTypes["actions"]["retryWorkflow"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
    ...
    apps: {
        ...
        createContentAttachmentForRepo: {
            (params?: RestEndpointMethodTypes["apps"]["createContentAttachmentForRepo"]["parameters"]): Promise<RestEndpointMethodTypes["apps"]["createContentAttachmentForRepo"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
