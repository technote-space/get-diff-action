 ...
 */
exports.isTargetEvent = (targets, context, options) => // eslint-disable-line @typescript-eslint/no-explicit-any,@typescript-eslint/explicit-module-boundary-types
 getBoolValue(core_1.getInput('IGNORE_CONTEXT_CHECK')) ||
