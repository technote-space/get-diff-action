...
class ApiHelper {
    ...
    constructor(octokit, context, logger, options) {
        ...
        this.createBlob = (rootDir, filepath) => __awaiter(this, void 0, void 0, function* () {
            const blob = yield this.octokit.git.createBlob({
        ...
        this.getCommit = () => __awaiter(this, void 0, void 0, function* () {
            return this.octokit.git.getCommit({
                owner: this.context.repo.owner,
                repo: this.context.repo.repo,
        ...
        this.getPR = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(key in this.prCache)) {
                this.prCache[key] = yield this.octokit.pulls.get({
                    owner: this.context.repo.owner,
                    repo: this.context.repo.repo,
        ...
        this.createTree = (blobs) => __awaiter(this, void 0, void 0, function* () {
            return this.octokit.git.createTree({
                owner: this.context.repo.owner,
                repo: this.context.repo.repo,
                'base_tree': (yield this.getCommit()).data.tree.sha,
        ...
        this.updateRef = (commit, refName, force) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.octokit.git.updateRef({
                    owner: this.context.repo.owner,
                    repo: this.context.repo.repo,
                    ref: refName,
                    sha: commit.data.sha,
        ...
        this.pullsCreate = (branchName, detail) => __awaiter(this, void 0, void 0, function* () {
            return this.octokit.pulls.create(Object.assign({ owner: this.context.repo.owner, repo: this.context.repo.repo, head: `${this.context.repo.owner}:${utils_1.getBranch(branchName, false)}`, base: (yield this.getRefForUpdate(false)).replace(/^heads\//, '') }, detail));
        });
        /**
        ...
        this.pullsUpdate = (number, detail) => __awaiter(this, void 0, void 0, function* () {
            return this.octokit.pulls.update(Object.assign({ owner: this.context.repo.owner, repo: this.context.repo.repo, 'pull_number': number, base: (yield this.getRefForUpdate(false)).replace(/^heads\//, ''), state: 'open' }, detail));
        });
        /**
        ...
        this.pullsCreateOrUpdate = (createBranchName, detail) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (pullRequest) {
                this.logger.startProcess('Updating PullRequest... [%s] -> [%s]', utils_1.getBranch(createBranchName, false), yield this.getRefForUpdate(false));
                ...
                this.logger.startProcess('Creating PullRequest... [%s] -> [%s]', utils_1.getBranch(createBranchName, false), yield this.getRefForUpdate(false));
        ...
        this.pullsCreateOrComment = (createBranchName, detail) => __awaiter(this, void 0, void 0, function* () {
            const pullRequest = yield this.findPullRequest(createBranchName);
            if (pullRequest) {
                this.logger.startProcess('Creating comment to PullRequest... [%s] -> [%s]', utils_1.getBranch(createBranchName, false), yield this.getRefForUpdate(false));
        ...
        this.branch = (_a = options) === null || _a === void 0 ? void 0 : _a.branch;
        this.sender = (_b = options) === null || _b === void 0 ? void 0 : _b.sender;
        this.refForUpdate = (_c = options) === null || _c === void 0 ? void 0 : _c.refForUpdate;
        this.suppressBPError = (_d = options) === null || _d === void 0 ? void 0 : _d.suppressBPError;
    }
    /**
    ...
    pullsList(params) {
        return __asyncGenerator(this, arguments, function* pullsList_1() {
            ...
            let page = 1;
            while (true) {
                const list = yield __await(this.octokit.pulls.list(Object.assign({
                    sort: 'created',
                    direction: 'asc',
                }, params, {
                    owner: this.context.repo.owner,
                ...
                yield __await(yield* __asyncDelegator(__asyncValues(list.data)));
            }
        });
    }
}
