    ...
    constructor(logger, options) {
        ...
        this.addOrigin = (workDir, context) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.runCommand(workDir, {
                ...
                args: ['origin', context_helper_1.getGitUrlWithToken(context, this.token)],
                quiet: this.isQuiet(),
        ...
        this.push = (workDir, branch, context, options) => __awaiter(this, void 0, void 0, function* () {
            ...
            const url = this.getOrigin(context);
            const args = [];
            if ((_m = options) === null || _m === void 0 ? void 0 : _m.withTag) {
                args.push('--tags');
            }
            if ((_o = options) === null || _o === void 0 ? void 0 : _o.force) {
                args.push('--force');
            }
            if ((_p = options) === null || _p === void 0 ? void 0 : _p.args) {
        ...
        this.getLastTag = (workDir) => __awaiter(this, void 0, void 0, function* () {
            ...
            return 'v' + (_r = (_q = tags.slice().sort(compareTag).reverse()[0]) === null || _q === void 0 ? void 0 : _q.replace(/^v/, ''), (_r !== null && _r !== void 0 ? _r : '0.0.0'));
        });
        /**
         * @param {string} workDir work dir
         * @return {string} tag
