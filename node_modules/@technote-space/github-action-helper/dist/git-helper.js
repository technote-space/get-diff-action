...
class GitHelper {
    ...
    constructor(logger, options) {
         ...
         */
        this.getOrigin = (context) => { var _a; return _a = this.origin, (_a !== null && _a !== void 0 ? _a : context_helper_1.getGitUrl(context)); };
        /**
         * @param {string} workDir work dir
        ...
        this.getLastTag = (workDir) => __awaiter(this, void 0, void 0, function* () {
            ...
            return 'v' + (_d = (_c = tags.slice().sort(compareTag).reverse()[0]) === null || _c === void 0 ? void 0 : _c.replace(/^v/, ''), (_d !== null && _d !== void 0 ? _d : '0.0.0'));
        });
        /**
         * @param {string} workDir work dir
         * @return {string} tag
